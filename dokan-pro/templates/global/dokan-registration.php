...
<form method="post" action="" class="dokan-social-form" novalidate>
    <div class="form-row-wide">
        <p class="form-row form-group">
            <label for="first-name">x<?php _e( 'First Name', 'dokan' ); ?> <span class="required">*</span></label>
    ...
    <div class="show_if_seller"<?php echo $role_style; ?>>
        ...
        <p class="form-row form-group form-row-wide">
            <label for="shop-phone"><?php _e( 'Phone Numberx', 'dokan' ); ?><span class="required">*</span></label>
